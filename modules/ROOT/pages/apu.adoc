...
build/tmp/deploy/images/scobc-v1/petalinux-image-minimal-scobc-v1-yyyyMMddHHmmss.wic
build/tmp/deploy/images/scobc-v1/petalinux-image-minimal-scobc-v1.wic@
----

NOTE: `petalinux-image-minimal-scobc-v1.wic` is a symlink to the latest build.
...
----
$ sudo dd if=build/tmp/deploy/images/scobc-v1/petalinux-image-minimal-scobc-v1.wic \
          of=/dev/sdX \
          bs=4M \
          status=progress \
          conv=fsync
